        ...
        <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <button
              type="button"
              onClick={onGenerate}
              className="rounded-full bg-[#1f1f1f] px-6 py-2 text-sm font-semibold text-white shadow-sm transition-all hover:-translate-y-0.5 hover:bg-black hover:shadow-md"
            >
              生成 YAML
            </button>
          </div>
